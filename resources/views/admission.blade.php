			...
			<div class="col-sm-12 events-full-box">
				<div class="events-single-box">
					<div class="row">
						...
						<p class="font-weight-bold">	 This is holy field. <br>
                                ...
                                To help young people discover and harness their potential to develope into useful members of the society.</p>
					...
					<div class="row">
						...
						<div class="col-sm-7 event-info">
							...
							<p class="font-weight-bold">
                                ...
                                Admission is on a first-come first-serve basis.</p>
				...
				<div class="events-single-box">
					<div class="row">
						...
						<div class="col-sm-7 event-info">
							...
							<p class="font-weight-bold">
                                    Our Academic teaching member of staff are professionals in their various fields. <br>
            ...
            <div class="col-sm-12 events-full-box">
				<div class="events-single-box">
					<div class="row">
						...
						<p class="font-weight-bold">This school consists of chilldren between the ages 3 - 5 years. Formal Academic work start under the guidance of Montessori trained class teacher with at least two class assistants.</p>
						...
						<div class="col-sm-7 event-info">
							...
							<p class="font-weight-bold">
                               Children are admitted into the secondary school and must have passed the prescribed entrance examination. <br>
                                The subject taught in the secondary school section include:  <br>
