                    ...
                    <div class="row all-corsess-wapper">
                        <div class="col-sm-12">
                            <div class="all-courses">
                                ...
                                <p>Our watchword stil remains academic and moral excellence. The school was officaially approved by Ogun State Ministry of education, Science and Technology to write the first school leaving certificate examination in April 2009. And as since turned ou total chldren who had held their shoulders high among their peers in other institution of higher learninig.</p>

                                <p>Today the school has suceeded in having the secondary section from junior to senior secondary. In the last two years of our attempt at WAEC or WASSCE, our school result was 100% outing with a minimum of 3A's and 2B's and only a credit in the last of one 2019</p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="instractor-courses-single">
                                        ...
                                        <div class="instractor-courses-text">
                                            ...
                                            <div class="text-bottom">
                                                <h3><a href="#">Prof. Akintunde Francis</a></h3>
                                                <p>A little detail about him</p>
                                            </div>
                                        </div>
